...
<div class="max-w-xl mx-auto p-6">
    <h1 class="text-xl font-semibold mb-6 text-gray-800 dark:text-white">Редагувати клас</h1>
    ...
    <form action="{{ route('classes.update', $class) }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <select name="school_id" id="school_id" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-white">
        ...
        <div>
            ...
            <input type="text" name="name" id="name" value="{{ $class->name }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-white" required>
        </div>
